...
export const badRequest = (res, { code, message, data }) => error(res, { code, message, data }, Status.BAD_REQUEST)

export const notFound = (res, { code, message, data }) => error(res, { code, message, data }, Status.NOT_FOUND)
